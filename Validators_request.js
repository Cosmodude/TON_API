...
var serverSideKey = env.ServerSideKey;
var exampleURL = 'https://swapi.dev/api/';
var tonapiURL = "https://tonapi.io/v1/blockchain/validators";
console.log(exampleURL);
var headers = { 'Authorization': 'Bearer ' + serverSideKey, Accept: 'application/json' };
var getValidators = function () {
    return __awaiter(this, void 0, void 0, function () {
        var _a, data, status;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(tonapiURL, { headers: headers })];
                case 1:
